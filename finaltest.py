...
class Stepper:
    ...
    def __init__(self, shifter, lock):
        ...
        self.busy = multiprocessing.Value('b', False)       # True while stepping
...
if __name__ == '__main__':
    ...
    m1.goAngle(90);    m1.wait(); time.sleep(0.01)
    m1.goAngle(-45);   m1.wait(); time.sleep(0.01)

    m2.goAngle(-90);   m2.wait(); time.sleep(0.01)
    m2.goAngle(45);    m2.wait(); time.sleep(0.01)

    m1.goAngle(-135);  m1.wait(); time.sleep(0.01)
    m1.goAngle(135);   m1.wait(); time.sleep(0.01)
    m1.goAngle(0);     m1.wait(); time.sleep(0.01)
